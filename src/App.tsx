// Lifting state up by example: Altering the show children's content functionality 
...
export default function Accordion() {
    ...
    return (
        <>
            ...
            >
                With a population of about 2 million, Almaty is Kazakhstant's largest city. From 1929 to 1997, it was its capital city.
            </Panel>
            <Panel
                title="Etymology"
